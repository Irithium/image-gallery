const Card = ({ image }) => {
  ...
  return (
    <div className="max-w-sm rounded-xl overflow-hidden shadow-lg bg-[#F6FFD6] ">
      <img src={image.webformatURL} alt="" className="w-full md:h-48 h-32" />
      <div className="px-4 py-3">
        <div className="font-bold text-[#25938F] max-md:text-base text-lg 2xl:text-xl mb-2">
          Photo by {image.user}
        </div>
        <ul className="flex items-center pt-1 justify-between max-sm:justify-center">
          <li>
            <div className="flex items-center justify-center rounded-full ">
              <svg
                ...
                stroke="#A2B9AD"
                className="max-sm:w-4 max-md:w-5 w-6 "
              >
              ...
              <p className="px-1 max-lg:pl-0 text-sm max-sm:text-xs">
                {image.views}
              </p>
            </div>
          </li>
          <li>
            ...
            <div className="flex items-center justify-center">
              ...
              <p className="px-1 max-lg:pl-0 text-sm text- max-sm:text-xs">
                {image.likes}
              </p>{" "}
            </div>
          </li>
      ...
      <div className="px-3 py-2">
        {tags.map((tag, index) => (
          <span
            key={index}
            className="capitalize inline-block bg-[#DDE5C2] rounded-full px-2 py-1 text-xs font-semibold text-[#2E2F2F] mr-2 my-1"
          >
            {tag}
          </span>
        ))}
