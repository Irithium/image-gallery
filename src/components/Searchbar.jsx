...
const Searchbar = ({ handleChangeTerm }) => {
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log(e.target);
    handleChangeTerm(e.target.term.value);
    e.target.term.value = "";
  };

  return (
    <form
      className="flex items-center md:m-4 my-4 max-md:h-[20px] w-full flex-grow justify-center"
      ...
      <div className="rounded-lg">
        <div className="flex ">
          ...
          <input
            ...
            id="term"
            name="term"
            className="w-full min-w-[50px]  2xl:text-xl xl:p-2 max-md:text-xs bg-cream-800 dark:bg-ultra_violet-600 dark:text-cream-800 dark:placeholder-gray-300 pl-2 text-base font-semibold outline-0 white"
